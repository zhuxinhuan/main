    ...
    return (
        <>
            ...
            <div className='home-content'>
                <div id='1'>
                    <LeftRight title="掌上地图" desc="更多描述..." img="https://ysr-resource-0205.oss-cn-chengdu.aliyuncs.com/uploads/6ec897d2b9d167888fe120fd987ffbf1.png"></LeftRight>
                ...
                <div id="2">
                    <div className='home-content-title'><Title text="景观互动"></Title></div>
                ...
                <div id="3">
                    <div className='home-content-title'><Title text="研学浏览"></Title></div>
                    <ShowBox imgList={[{ id: 1 }, { id: 2 }, { id: 3 }, { id: 4 }, { id: 5 }]} />
                </div>
                <div id="4">
                    <LeftRight title="掌上导览" desc="更多描述..." img="https://ysr-resource-0205.oss-cn-chengdu.aliyuncs.com/uploads/cff659c5c46f9a4b52ed552a9342c200.png"></LeftRight>
                ...
                <div>
                    <LeftRight title="剧情游览" rtl desc="更多描述..." img="https://ysr-resource-0205.oss-cn-chengdu.aliyuncs.com/uploads/4b82bbf1a9bfed1758fcb23530537a6b.png"></LeftRight>
                    {/* <div className='home-content-title'><Title text="剧情游览"></Title></div>
                ...
                <div id="5">
                    <div className='home-content-title'><Title text="合作案例"></Title></div>
                    <CaseBox imgList={[]} />
                </div>
            </div>
